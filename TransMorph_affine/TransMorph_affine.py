...
class SwinAffine(nn.Module):
    def __init__(self, config):
        ...
        self.aff_head = nn.Linear(49152, 100)
        ...
        self.scl_head = nn.Linear(49152, 100)
        ...
        self.trans_head = nn.Linear(49152, 100)
        ...
        self.shear_head = nn.Linear(49152, 100)
