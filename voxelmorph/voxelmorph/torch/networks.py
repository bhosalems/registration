...
class VxmDense(LoadableModel):
    ...
    def __init__(self,
        ...
        # dice function
        self.dicefn = Dice().loss

    def forward(self, source, target, moving_seg=None, fixed_seg=None, registration=False):
        '''
        Parameters:
        ...
        # warp the segmentation with flow field
        ...
        if not registration:
            return (y_source, y_target, preint_flow) if self.bidir else (y_source, preint_flow, dice)
        else:
            return y_source, pos_flow, dice
